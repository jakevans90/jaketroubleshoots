---
schemaVersion: 1
title: "Stryker ProCuity Hospital Bed - Brake Not Set Warning or Brake Sensor Failure"
issueTitle: "Brake Not Set Warning or Brake Sensor Failure"
description: "Troubleshooting a persistent brake warning, incorrect brake-status indication, incomplete brake engagement, caster movement, or an externally verifiable brake sensing concern."
assetType: "Hospital Bed"
manufacturer: "Stryker"
model: "ProCuity"
slug: "stryker-procuity-brake-not-set-warning-or-brake-sensor-failure"
dateAdded: "2026-07-27"
taxonomyMode: "reuse"
ccr:
  complaint: "Nursing reported that the Brake Not Set warning remained active after the brake pedal was engaged and the bed moved slightly when pushed."
  cause: "Clinical Engineering found tape and linen fibers wrapped around one caster, preventing complete brake engagement."
  resolution: "The debris was removed, all casters were inspected, and repeated brake engagement, release, holding, and status-indication tests were completed successfully."
helpfulDetails:
  - "Exact warning or indicator behavior"
  - "Brake pedal travel and feel"
  - "Bed movement with brakes engaged"
  - "Test-surface condition"
  - "Individual caster findings"
  - "Debris or visible damage"
  - "Accessible linkage condition"
  - "AC and battery behavior"
  - "Wiring or connector findings"
  - "Results of repeated brake cycles"
  - "Related safety-function behavior"
