---
schemaVersion: 1
title: "Stryker ProCuity Hospital Bed - Side Rail Controls or Patient Pendant Not Responding"
issueTitle: "Side Rail Controls or Patient Pendant Not Responding"
description: "Troubleshooting unresponsive side rail or pendant controls caused by lockouts, power, loose connections, cable damage, contamination, or a localized control-interface fault."
assetType: "Hospital Bed"
manufacturer: "Stryker"
model: "ProCuity"
slug: "stryker-procuity-side-rail-controls-or-patient-pendant-not-responding"
dateAdded: "2026-07-27"
taxonomyMode: "reuse"
ccr:
  complaint: "Nursing reported that the patient pendant would not operate any bed movement functions, although the side rail caregiver controls remained functional."
  cause: "Clinical Engineering found the pendant connector partially disengaged and the cable under tension from improper routing around the side rail."
  resolution: "The connector was reseated, the cable was rerouted with proper slack, and all pendant and side rail functions were tested successfully."
helpfulDetails:
  - "Exact control panel or pendant affected"
  - "Buttons or functions affected"
  - "Lockout status"
  - "AC and battery condition"
  - "Side rail position during failure"
  - "Pendant housing and cable condition"
  - "Connector condition"
  - "Evidence of fluid intrusion or contamination"
  - "Known-good pendant test result"
  - "Nurse call or associated control behavior"
