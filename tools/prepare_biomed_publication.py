...
RELATED = {
    ...
    "sensors-and-transducers-basics": ["how-ecg-acquisition-works", "how-spo2-measurement-works", "how-nibp-works-in-a-patient-monitor", "analog-vs-digital-signals", "medical-device-alarm-troubleshooting-fundamentals"],
