...
class BiomedBasicAnalyzerTests(unittest.TestCase):
    ...
    def test_published_articles_are_removed_from_planned_topics(self):
        ...
        self.assertNotIn("How Temperature Probes and Thermistors Work", planned)
        self.assertNotIn("Ethernet Ports, Link Lights, and What They Tell You", planned)
        self.assertNotIn("Ports, Firewalls, and Why a Device Can Ping but Still Not Work", planned)
        self.assertNotIn("How to Work With IT as a Biomed", planned)
        self.assertNotIn("Why Medical Equipment Reboots", planned)
        self.assertNotIn("Calibration Stickers: What They Do and Don’t Mean", planned)
        ...
        self.assertNotIn("The First Ten Minutes of a Service Call", planned)
        self.assertNotIn("How to Use Equipment History During Troubleshooting", planned)
        self.assertNotIn("What to Check Before Ordering Parts", planned)
        self.assertNotIn("When a Repair Needs Extended Observation or Burn-In", planned)
        self.assertNotIn("Incoming Inspection Basics", planned)
        self.assertNotIn("How to Build a Useful Escalation Package", planned)
        self.assertNotIn("Service Mode and Built-In Diagnostics: What to Trust", planned)
        self.assertNotIn("How to Investigate Repeat Failures", planned)
        self.assertNotIn("What Should Actually Happen During a PM?", planned)
        self.assertNotIn("PM Documentation Basics", planned)
        self.assertNotIn("Recall and Safety Notice Basics", planned)
        self.assertNotIn("Medical Device Cybersecurity Basics", planned)
        self.assertIn("IP Addresses, Subnets, Gateways, and DNS in Plain English", planned)
    ...
    def test_biomed_catalog_is_complete_and_landing_loads_it(self):
        ...
        self.assertEqual(len(catalog), 131)
